...
function icon(size) {
  ...
  <text x="${size * 0.5}" y="${size * 0.48}" font-family="'SF Mono','Fira Code','Courier New',monospace" font-size="${fs}" font-weight="700" text-anchor="middle" dominant-baseline="middle"><tspan fill="${AMBER}">d</tspan><tspan fill="${GREEN}">&gt;</tspan></text>
</svg>`
}
